...
const QA = () =>{
  return (
    <div className='q-abox'>
      ...
      <h2 className='basictext'>Lake Louisa State Park is located in Clermont, Florida. The closest airport to the park is the Orlando International Airport (MCO) which is approximately 38 miles or a 45 minute drive from the venue.
